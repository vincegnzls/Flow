...
struct EventNames {
    ...
    static let ACCIDENTAL_PRESS = "ACCIDENTAL_PRESS"
    ...
    static let HIGHLIGHT_SELECTED_MEASURE = "HIGHLIGHT_SELECTED_MEASURE"
    static let HIGHLIGHT_MEASURE = "HIGHLIGHT_MEASURE"
    static let HIGHLIGHT_NOTATIONS = "HIGHLIGHT_NOTATIONS"
    static let HIDE_TEMPO_MENU = "HIDE_TEMPO_MENU"
    
    static let SELECT_KEY_SIGNATURE = "SELECT_KEY_SIGNATURE"

    static let HIGHLIGHT_ACCIDENTAL_BTN = "HIGHLIGHT_ACCIDENTAL_BTN"
    static let REMOVE_ACCIDENTAL_HIGHLIGHT = "REMOVE_ACCIDENTAL_HIGHLIGHT"
    ...
    static let CONNECT_HIGHLIGHT = "CONNECT_HIGHLIGHT"
